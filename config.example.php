...
return [
    'octopus' => [
        ...
        // Campaign slug for detecting Fill your boots (Free Electricity/Power Up) sessions
        // via customerFlexibilityCampaignEvents (src/OctopusFlexClient.php) — confirmed
        // live. Power down uses a different, slug-less API (see that class's doc comment),
        // so there's no equivalent setting for it here.
