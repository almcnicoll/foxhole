...
<form method="post">
    ...
    <fieldset>
        ...
        <p class="muted">Optional — only needed for the dashboard's opt-in session banner ("Power down"/"Fill your
            boots"). Leave all fields blank to hide that banner entirely. API key + account number alone are enough
            for Power down; MPAN is additionally required to also detect Fill your boots (Free Electricity) sessions
            — confirmed live that Octopus's API requires it for that lookup specifically. Your account API key is on
        ...
        <label for="octopus_mpan">MPAN (optional — only needed to also detect Fill your boots sessions)</label>
